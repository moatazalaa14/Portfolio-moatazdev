...
const index = ({endPoint}) => {
  ...
  return (
    <div className="flex flex-col flex-grow">
      ...
      I'm student at Specific Education. Currently, I'm working as Learning design Specialist at Variiance.But i wnt to shift carrer to development filed as a Front-end developer.I always seek to upgrade my skills and catch up with the accelerating rate of technology development.      </p>
