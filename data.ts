...
import { Iservice, Iexperience, Iprojects,Iarticles ,Icourses ,IprojectPages} from './type';
...
export const projectPages:IprojectPages[]=[
    {
        ...
        demo:"Tnta2lkqgAk",
        url:"/gamified_course_1"
    },
    {
        title:"Color Blind Accessiblity Feature - Using Articulate Storyline360 and Javascript →",
        demo:"mZkNY38BGtU",
        url:"/color_blind_2"
    },
    {
        title:"ChatBot using Watson course →",
        demo:"667Ik7H86GM",
...
export const experiences:Iexperience[]=[
    ...
    },
    {
        ...
        responsiblities:["Develop a process for creating interactive courses that the team will follow." ,
         "Create the initial documents for interactive courses, such as a testing document, style guide, and requirements for the platform.",
