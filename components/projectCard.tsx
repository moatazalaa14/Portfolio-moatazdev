	...
	return (
		<div>
			...
			<Modal isOpen={modalIsOpen} onRequestClose={closeModal} contentLabel="Example Modal" style={customStyles}>
				<div className="absolute top-0 left-0 z-10 grid items-center w-full h-screen grid-cols-1 bg-gray-200 md:grid-cols-2 gap-x-12 dark:bg-dark-200 justify-items-center">
					<div>
