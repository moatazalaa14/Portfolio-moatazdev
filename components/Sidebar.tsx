...
function Sidebar() {
	...
	return (
		<div>
			...
			<a href="" className="flex items-center justify-center py-1 my-3 bg-gray-200 rounded-full dark:bg-dark-200 px2" download="name">
			...
			<div>
                ...
                >Email Me</button>
				<button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400 focus:outline-none" onClick={HandlingTheme}>{theme==="light"?"Dark":"Light"} Ui</button>
			</div>
		</div>
	);
}
