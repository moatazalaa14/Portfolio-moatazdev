	...
	return (
		<div>
			...
			<div>
                ...
                >Email Me</button>
				<button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400 focus:outline-none" onClick={HandlingTheme}>{/*theme==="light"?"Dark":"Light"*/}Go Dark</button>
			</div>
		</div>
	);
}
